...
def run_agent(db: Session, question: str, session_id: int | None = None, project_id: int = 1, reasoning_effort: str | None = None, history: list[dict] | None = None, on_delta=None) -> dict:
